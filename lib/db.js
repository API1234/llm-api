...
function getDbClient() {
  ...
  if (!postgresUrl) {
    throw new Error(
      ...
      'If using Vercel Postgres, it should be automatically provided. ' +
      'Otherwise, set it to your PostgreSQL connection string (e.g., postgresql://user:password@host:port/database)'
    );
  }

  dbClient = createClient({ connectionString: postgresUrl });
  return dbClient;
}
